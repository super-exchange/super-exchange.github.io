---
title: Official API Document Of Super-exchange
...
Welcome to Super-exchange Developer Documentation. It is the only official documentation of Super-exchange API.
...
The services provided by Super-exchange API will be continuously updated here, so stay tuned for updates.
...
[You can click here to create an API Key]: https://www.super-exchange.co/#/user/bindAuth/ManagementAPI
...
## Interface Type
Super-exchange provides users with two interfaces, and you can choose the appropriate way to query the ticker and trade according to your own usage scenarios and preferences.
...
`https://api.super-exchange.co/api`

**WebSocket**

`wss://ws.super-exchange.co/s/ws`
...
- method request address: Access server address api.super-exchange.co，e.g. https://api.super-exchange.co/api/trade/order/place
...
import time
import requests
url = "https://api.super-exchange.co/api/v2/public/config/spot/symbols"
...
headers = {
 ...
 'Accept': '*/*',
 # 'Host': 'https://api.super-exchange.co',
...
url = "https://api.super-exchange.co/api/fi/v1/common/currency?currencyCode=ETH"
api_key = b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
import time
import requests
url = "https://api.super-exchange.co/api/spot/accountList"
api_key=b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
url = "https://api.super-exchange.co/api/fi/v3/asset/deposit/do"
api_key = b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
url = "https://api.super-exchange.co/api/fi/v3/asset/deposit/record/list"
api_key = b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
url = "https://api.super-exchange.co/api/fi/v3/asset/withdraw/record/list"
api_key = b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
url = "https://api.super-exchange.co/api/fi/v3/asset/doWithdraw"
api_key = b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
url = "https://api.super-exchange.co/api/fi/v3/asset/cancelWithdraw"
api_key = b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
#### Currently supporting contract<->spot transfer, API domain name address https://futures.api.super-exchange.co/api Call support for ApiKey
...
url = "https://api.super-exchange.co/api/v1/future/transfer"
api_key = b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
import time
import requests 
url = "https://api.super-exchange.co/api/trade/order/active"
api_key=b'your api_key'
secret_key = b'your secret_key' 
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
#### The new interface API domain name address `https://api.super-exchange.co`  Call support for ApiKey
...
import time
import requests
url = "https://api.super-exchange.co/api/v2/trade/order/active"
api_key=b'your api_key'
secret_key = b'your secret_key' 
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
import time
import requests
url = "https://api.super-exchange.co/api/trade/match/accountMatches?symbol=tipusdt"
api_key=b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time()* 1000)
expires_key = str(math.floor(expires / 30000))
...
import requests
import json
url = "https://api.super-exchange.co/api/trade/order/cancel"
api_key=b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
#### Regular user accounts are only allowed to hold up to 50 active orders at the same time, while market-making accounts are not subject to this restriction.If you are a market maker but do not have permission to add a market-making account, please contact the Super-exchange delivery department.
...
import time
import requests
url = "https://api.super-exchange.co/api/trade/order/place"
api_key=b'your api_key'
...
import time
import requests
url = "https://api.super-exchange.co/api/trade/order/placeBatch"
api_key=b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time() * 1000)
expires_key = str(math.floor(expires / 30000))
...
import requests
import json
url = "https://api.super-exchange.co/api/trade/order/cancelBatch"
api_key=b'your api_key'
...
import time
import requests
url = "https://api.super-exchange.co/api/trade/order/orderInfo?ordId=1780715084580128"
api_key=b'your api_key'
secret_key = b'your secret_key'
expires = int(time.time()* 1000)
expires_key = str(math.floor(expires / 30000))
...
import time
import requests
url = "https://api.super-exchange.co/api/v2/trade/order/orderInfo?ordId=1780715084580128"
api_key=b''
secret_key = b''
expires = int(time.time()* 1000)
expires_key = str(math.floor(expires / 30000))
