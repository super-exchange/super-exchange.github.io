---
title: Super-exchange official API document
...
You can click 'https://www.super-exchange.co/#/user/bindAuth/ManagementAPI' to create an API Key.
...
`https://futures.super-exchange.co/api`

**WebSocket**

`wss://ws-futures.super-exchange.co/socket.io/?EIO=3&transport=websocket`
...
- method request address: Access server address futures.super-exchange.co，e.g. https://futures.super-exchange.co/api/future/place
...
#### The new interface API domain name address `https://futures.super-exchange.co`  Call support for ApiKey
