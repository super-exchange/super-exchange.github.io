...
您可以点击 'https://www.super-exchange.co/#/user/bindAuth/ManagementAPI' 创建 API Key。
...
一个合法的请求由以下几部分组成：
- 方法请求地址：即访问服务器地址futures.super-exchange.co，比如https://futures.super-exchange.co/api/trade/order/place
- 必须和可选参数。
...
#### 新接口的 API域名地址 `https://futures.super-exchange.co`  调用支持ApiKey
